    ...
    return (
        <div id="container-gridHomeP1_Desktop">
            ...
            <div className="container-right-flex__HomeP1-DESKTOP">
                ...
                <Image src='/images/foto-igna2.jpg' width={100} height={100} sizes='100%' className='image-right__HomeP1-DESKTOP animate__animated animate__fadeIn animate__delay-2s animate__slow	' />
            </div>
        </div>
    )
}