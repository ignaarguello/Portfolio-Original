  ...
  return (
    <div id="container-general__Home_P1">
      ...
      <div id="container-info__Home-P1">
        <h2 className="item-text__Home-P1 animate__animated animate__fadeInLeft">Argüello Ignacio</h2>
